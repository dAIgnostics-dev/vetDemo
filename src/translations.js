export const translations = {
  en: {
    ...
    dictation_error_denied: "Not authorised to use transcription. The backend is likely not deployed — run `npx ampx sandbox` or download a fresh amplify_outputs.json.",
    dictation_error_mic: "Microphone access was blocked. Allow it in your browser's site settings and try again.",
    dictation_error_no_mic: "No microphone available. Check that one is connected and not in use by another app.",
    dictation_error_insecure: "Dictation needs a secure connection. Open the app over HTTPS or on localhost.",
    dictation_error_config: "Transcription rejected the request — check the language and custom vocabulary for this region.",
    dictation_error_generic: "Dictation stopped unexpectedly. Please try again.",
  ...
  hr: {
    ...
    dictation_error_denied: "Nema ovlasti za transkripciju. Backend vjerojatno nije deployan — pokrenite `npx ampx sandbox` ili preuzmite novi amplify_outputs.json.",
    dictation_error_mic: "Pristup mikrofonu je blokiran. Dopustite ga u postavkama preglednika i pokušajte ponovno.",
    dictation_error_no_mic: "Mikrofon nije dostupan. Provjerite je li spojen i ne koristi li ga druga aplikacija.",
    dictation_error_insecure: "Diktat zahtijeva sigurnu vezu. Otvorite aplikaciju preko HTTPS-a ili na localhostu.",
    dictation_error_config: "Transkripcija je odbila zahtjev — provjerite jezik i custom vocabulary za ovu regiju.",
    dictation_error_generic: "Diktat je neočekivano prekinut. Pokušajte ponovno.",
